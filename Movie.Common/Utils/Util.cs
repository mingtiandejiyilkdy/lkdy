...
namespace Movie.Common.Utils
{
    ...
    { 
        ...
        /// 系统标题
        /// </summary>
        public static string WebName { get { return AppSettings.Get("WebName"); } }

        /// <summary>
        /// 系统Logo
        /// </summary>
        public static string WebLogo { get { return AppSettings.Get("WebLogo"); } }

        /// <summary>
        /// 配置的无需登录即可访问的页面
        /// </summary>
        public static string WebAllowPages { get { return AppSettings.Get("AllowPages"); } }

        /// <summary>
        /// 调试开关
        /// </summary>
        public static string LocalhostSwitch { get { return AppSettings.Get("LocalhostSwitch"); } }

        /// <summary>
        /// 配置的web路径
        /// </summary>
        public static string WebPath { get { return AppSettings.Get("WebPath"); } }

        /// <summary>
        /// 配置的Css路径
        /// </summary>
        public static string WebCssPath { get { return AppSettings.Get("WebCssPath"); } }

        /// <summary>
        /// 配置的Js路径
        /// </summary>
        public static string WebJsPath { get { return AppSettings.Get("WebJsPath"); } } 
        #endregion
        ...
        /// 删除最后结尾的一个逗号
        /// </summary>
        public static string DelIndexStr(string str)
        {
            return DelIndexStr(str, ",");
        }
        #endregion
        ...
        /// 删除最后结尾的指定字符后的字符
        /// </summary>
        public static string DelIndexStr(string str, string strchar)
        {
            if (string.IsNullOrEmpty(str))
                return "";
            int n = str.IndexOf(strchar);
        ...
        /// 删除最后结尾的指定字符后的字符
        /// </summary>
        public static string DelLastStr(string str, string strchar)
        {
            if (string.IsNullOrEmpty(str))
                return "";
            int n = str.LastIndexOf(strchar);
        ...
        /// <returns></returns>
        public static string CheckMobile(string strMobile)
        {
            string s = @"^(13[0-9]|15[0-9]|14[5|7|8|9]|18[0-9])[0-9]{8}$";
            if (Regex.IsMatch(strMobile, s))
            {
                return "";
            }
            else
            {
                return string.IsNullOrEmpty(strMobile) ? "空格" : strMobile;
            }
        }
        #endregion
